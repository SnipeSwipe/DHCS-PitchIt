...
//
    ...
    public void rowClick(View view){
        Toast.makeText(Profile5.this, "Feature Not Available", Toast.LENGTH_SHORT).show();
    }
...
//        Toast.makeText(Profile.this, "", Toast.LENGTH_SHORT).show();
    ...
    public void photoClick(View view){
        Intent intent = new Intent(Profile5.this, ProfilePhotos.class);
        startActivity(intent);
    }

    public void videoClick(View view){
        Intent intent = new Intent(Profile5.this, ProfileVideos.class);
        startActivity(intent);
    }
