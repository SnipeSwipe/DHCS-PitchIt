...
//
    ...
    public void rowClick(View view){
        Toast.makeText(Profile2.this, "Feature Not Available", Toast.LENGTH_SHORT).show();
    }
...
//        Toast.makeText(Profile.this, "", Toast.LENGTH_SHORT).show();
    ...
    public void photoClick(View view){
        Intent intent = new Intent(Profile2.this, ProfilePhotos.class);
        startActivity(intent);
    }

    public void videoClick(View view){
        Intent intent = new Intent(Profile2.this, ProfileVideos.class);
        startActivity(intent);
    }

    public void chatStart(View view){
        Intent intent = new Intent(Profile2.this, ChatTestActivity2.class);
        startActivity(intent);
    }
}
